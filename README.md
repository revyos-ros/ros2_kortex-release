...
The packages in the `ros2_kortex` repository were released into the `humble` distro by running `/root/venv/bin/bloom-release -r humble ros2_kortex --override-release-repository-push-url git@github.com:revyos-ros/ros2_kortex-release.git --edit` on `Thu, 06 Mar 2025 03:36:53 -0000`
...
- release repository: https://github.com/revyos-ros/ros2_kortex-release.git
